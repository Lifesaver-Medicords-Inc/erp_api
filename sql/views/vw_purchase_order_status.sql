IF NOT EXISTS (SELECT 1 FROM sys.views WHERE name = 'vw_purchase_order_status' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    EXEC('CREATE VIEW [dbo].[vw_purchase_order_status] AS SELECT 1 AS placeholder')
END
GO
ALTER VIEW [dbo].[vw_purchase_order_status] AS
