IF NOT EXISTS (SELECT 1 FROM sys.views WHERE name = 'GetWiringNotes' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    EXEC('CREATE VIEW [dbo].[GetWiringNotes] AS SELECT 1 AS placeholder')
END
GO
