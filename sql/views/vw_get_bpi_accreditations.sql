IF NOT EXISTS (SELECT 1 FROM sys.views WHERE name = 'vw_get_bpi_accreditations' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    EXEC('CREATE VIEW [dbo].[vw_get_bpi_accreditations] AS SELECT 1 AS placeholder')
END
GO
