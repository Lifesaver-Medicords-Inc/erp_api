IF NOT EXISTS (SELECT 1 FROM sys.views WHERE name = 'vw_get_bpi_list' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    EXEC('CREATE VIEW [dbo].[vw_get_bpi_list] AS SELECT 1 AS placeholder')
END
GO
