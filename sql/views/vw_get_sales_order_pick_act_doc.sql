IF NOT EXISTS (SELECT 1 FROM sys.views WHERE name = 'vw_get_sales_order_pick_act_doc' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
    EXEC('CREATE VIEW [dbo].[vw_get_sales_order_pick_act_doc] AS SELECT 1 AS placeholder')
END
GO
